...
local stuck_threshold = 1  -- Seconds before considering player stuck
local last_unstuck_attempt_time = 0
local unstuck_cooldown = 2  -- Seconds between unstuck attempts
local unstuck_attempt_timeout = 3  -- 5 seconds timeout
