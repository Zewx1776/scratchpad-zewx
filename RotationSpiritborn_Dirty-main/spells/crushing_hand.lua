...
local menu_elements =
{
    ...
    targeting_mode = combo_box:new(3, get_hash(my_utility.plugin_label .. "crushing_hand_base_targeting_mode")),
}
...
local function logics(target)
    ...
    local is_logic_allowed = my_utility.is_spell_allowed(
        ...
        spell_data.crushing_hand.spell_id);
    ...
    if cast_spell.target(target, spell_data.crushing_hand.spell_id, 0, false) then
        local current_time = get_time_since_inject();
        next_time_allowed_cast = current_time + my_utility.spell_delays.regular_cast;

        console.print("Cast Crushing Hand - Target: " ..
