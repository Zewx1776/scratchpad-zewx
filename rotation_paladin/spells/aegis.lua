...
local menu_elements = {
    ...
    main_boolean = checkbox:new(false, get_hash(my_utility.plugin_label .. "aegis_main_bool")),
    cooldown = slider_float:new(0.0, 5.0, 0.5, get_hash(my_utility.plugin_label .. "aegis_cooldown")),
}

local function menu()
    if menu_elements.tree_tab:push("Aegis") then
        menu_elements.main_boolean:render("Enable Spell", "Defensive shield")
