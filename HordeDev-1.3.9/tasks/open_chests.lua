    ...
    wait_for_vfx = function(self)
        ...
        if tracker.check_time("chest_vfx_wait", 1) then
            ...
            for _, actor in pairs(actors) do
                ...
                if name == "vfx_resplendentChest_coins" or name == "vfx_resplendentChest_lightRays" or not chest:is_interactable() then
                    console.print("Chest opened successfully: " .. self.current_chest_type)
                    self.failed_attempts = 0
